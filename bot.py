from pyrogram import Client, pyrogram.filters, MessageHandler
...
@app.on_message(pyrogram.filters.regex("^[Ll] (.*)$") & pyrogram.filters.group , group=-20)
...
# Input Link
@app.on_message(pyrogram.filters.regex(r"[Hh][Tt][Tt][Pp]|[tT].[Mm][Ee]|[Ww][Ww][Ww]|\.[Mm][Ee]") & pyrogram.filters.group , group=-21)
...
# Input Forward
@app.on_message(pyrogram.filters.forwarded & pyrogram.filters.group, group=-22)
...
@app.on_message(pyrogram.filters.reply & pyrogram.filters.regex("^[Mm] (.*)$"))
...
@app.on_message(pyrogram.filters.text & pyrogram.filters.group)
...
@app.on_message(pyrogram.filters.text & pyrogram.filters.private, group=-23)
...
@app.on_message(pyrogram.filters.text & pyrogram.filters.me, group=-2)
...
@app.on_message(pyrogram.filters.regex("^[Aa]ddf (.*)"), group=6)
...
@app.on_message(pyrogram.filters.regex("[Dd]elf (.*)"), group=4)
...
#@app.on_message(pyrogram.filters.regex("[Ll]istf"), group=5)
def l_listf(message):
    fl = r.smembers("fosh")
    text = ""
    count = 1
...
@app.on_message(pyrogram.filters.regex("(\d*) ta (\d*) (.*)"), group=3)
...
@app.on_message(pyrogram.filters.animation & (pyrogram.filters.group | pyrogram.filters.private), group=-5)
...
@app.on_message(pyrogram.filters.voice & (pyrogram.filters.group | pyrogram.filters.private), group=-6)
...
@app.on_message(pyrogram.filters.photo & (pyrogram.filters.group | pyrogram.filters.private), group=-7)
...
@app.on_message(pyrogram.filters.sticker & (pyrogram.filters.group | pyrogram.filters.private), group=-8)
...
@app.on_message(pyrogram.filters.group & pyrogram.filters.reply & pyrogram.filters.regex("^([Cc]k)$"), group=2)
...
@app.on_message(pyrogram.filters.group & pyrogram.filters.reply & pyrogram.filters.regex("^[Pp]in$") , group=1)
...
#Just For Fun :)
@app.on_message((pyrogram.filters.group|pyrogram.filters.private) & pyrogram.filters.regex("^[Rr]eload$") , group=1)
...
@app.on_message(pyrogram.filters.regex("^[Ff]uck it$") & pyrogram.filters.reply , group=1)
...
@app.on_message(pyrogram.filters.regex("^[Dd]el fuck$") & pyrogram.filters.reply , group=7)
...
@app.on_message(pyrogram.filters.regex("^[Pp]y$") & pyrogram.filters.reply , group=8)
...
@app.on_message(pyrogram.filters.regex("^[Dd]$"),group=9)
...
@app.on_message(pyrogram.filters.regex("^[Cc]learb$") , group=10)
...
@app.on_message(pyrogram.filters.regex("^([Ii]d)$") , group=11)
...
@app.on_message(pyrogram.filters.regex("^([Pp]) (.*)$") , group=12)
def jss_myid(client,message):
    myid = message.from_user.id
    if myid != me(app):return
...
@app.on_message(pyrogram.filters.regex("^([Nn]obody|[Ee]verybody)$") & pyrogram.filters.me , group=15)
...
@app.on_message(pyrogram.filters.regex("^[Ss]pam (\d*)$") & pyrogram.filters.reply , group=16)
...
@app.on_message(pyrogram.filters.regex("^[Ss]pamf (\d*)$") & pyrogram.filters.reply & pyrogram.filters.me , group=17)
...
@app.on_message(pyrogram.filters.regex("^[Aa]ction$") & pyrogram.filters.me, group=18)
...
@app.on_message(pyrogram.filters.regex("^[Ss]etaction (.*)$") & pyrogram.filters.me , group=19)
...
@app.on_message(pyrogram.filters.regex("^[Aa]ctionlist$") & pyrogram.filters.me , group=20)
...
@app.on_message(pyrogram.filters.regex("^[sS]ettings$") & pyrogram.filters.me , group=21)
...
#Added To list
#@app.on_message(pyrogram.filters.regex("^[Bb]lacklist$") & pyrogram.filters.me , group=22)
...
@app.on_message(pyrogram.filters.regex("^[Aa]ction (.*)$") & pyrogram.filters.me, group=23)
...
@app.on_message(pyrogram.filters.regex("^[Cc]learf$") & pyrogram.filters.me, group=24)
def jss_clearf(client,message):
    r.delete("fosh")
...
@app.on_message(pyrogram.filters.regex("^[Ff]ilterf$") & pyrogram.filters.me, group=25)
...
@app.on_message(pyrogram.filters.regex("^[hH]elp$") & pyrogram.filters.me, group=26)
def jss_clearf(client,message):
...
@app.on_message(pyrogram.filters.regex("^[Ss]et (.*)$") & pyrogram.filters.me , group=30)
...
@app.on_message(pyrogram.filters.regex("^[Dd]cmd (.*)$") & pyrogram.filters.me , group=32)
...
@app.on_message(pyrogram.filters.regex("^[Aa]utodel? ?(\d*)$") & pyrogram.filters.me , group=33)
...
@app.on_message(pyrogram.filters.regex("^[Ff]maker$") & pyrogram.filters.me , group=34)
...
#@app.on_message(pyrogram.filters.regex("^[Aa]ddserver$") & pyrogram.filters.me & pyrogram.filters.reply, group=35)
#Deleted


#@app.on_message(pyrogram.filters.regex("^[Cc]onnect$") & pyrogram.filters.me , group=36)
#Deleted

@app.on_message(pyrogram.filters.regex("^[Ss]een? ?(.*)$") & pyrogram.filters.me , group=37)
...
@app.on_message(pyrogram.filters.incoming & pyrogram.filters.private, group=38)
...
@app.on_message(pyrogram.filters.incoming & pyrogram.filters.channel, group=39)
...
@app.on_message(pyrogram.filters.incoming & pyrogram.filters.group, group=40)
...
@app.on_message(pyrogram.filters.regex("^[Uu]nmark? ?(.*)$") & pyrogram.filters.me, group=41)
...
#@app.on_message(pyrogram.filters.regex("GET") & pyrogram.filters.me, group=42)
...
@app.on_message(pyrogram.filters.regex("^[Mm]ark") & pyrogram.filters.me, group=43)
...
@app.on_message(pyrogram.filters.regex("^[Pp]rice (.*)$") & pyrogram.filters.me, group=44)
...
@app.on_message(pyrogram.filters.regex("^[Rr]set (.*)$") & pyrogram.filters.me, group=45)
...
@app.on_message(pyrogram.filters.regex("^[Rr]sadd (.*)$") & pyrogram.filters.me, group=46)
def jss_rset(client, message):
    if message.text.count(" ") == 2:
        args = message.text.split(" ")
...
@app.on_message(pyrogram.filters.regex("^[Rr]srem (.*)$") & pyrogram.filters.me, group=47)
def jss_rset(client, message):
    if message.text.count(" ") == 2:
        args = message.text.split(" ")
...
@app.on_message(pyrogram.filters.regex("^[Ll]ist (.*)$") & pyrogram.filters.me, group=48)
...
@app.on_message(pyrogram.filters.regex("^[Dd]el (.*) (.*)$") & pyrogram.filters.me, group=49)
...
#Fuck this shit 
#@app.on_message(pyrogram.filters.regex("^[Bb]io? ?(.*)$" & pyrogram.filters.me) , group=50)
...
@app.on_message(pyrogram.filters.regex("^[Tt]oday$") & pyrogram.filters.me ,group=50)
...
@app.on_message(pyrogram.filters.regex("[\+\-\*\%]+") & pyrogram.filters.me, group=52)
...
#@app.on_message(pyrogram.filters.me & pyrogram.filters.regex("^![Tt] (.*) (.*)$") , group=54)
#Just JSS


#@app.on_message(pyrogram.filters.group & pyrogram.filters.photo , group=55)
#Just JSS
    

#@app.on_message(pyrogram.filters.me & pyrogram.filters.regex("^[Rr]iz (.*)$") , group=56)
#Just JSS
